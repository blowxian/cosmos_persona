                ...
                <DialogDescription>
                    <div className="flex items-center flex-col py-1 md:py-2 lg:py-3">
                        ...
                        <div className="flex mt-4">
                            <FacebookShareButton url={'https://cosmospersona.net'}
                                                 title={'Cosmos Persona Personality Quiz'}
                                                 className="mr-2 mt-3 md:mt-5">
                                <FacebookIcon size={32} round/>
                            </FacebookShareButton>
                            <TwitterShareButton url={'https://cosmospersona.net'}
                                                title={'Cosmos Persona Personality Quiz'} className="mr-2 mt-3 md:mt-5">
                                <TwitterIcon size={32} round/>
                            </TwitterShareButton>
                            <LinkedinShareButton url={'https://cosmospersona.net'}
                                                 title={'Cosmos Persona Personality Quiz'}
